...
cap_list = range(1,num_vehicles+1,4)
...
for t in range(NUM_TRIES):
	...
	for channel_capacity_index in range(len(cap_list)):
		...
		merged = merge_count_matrices(tx, vehicles, MERGE_MODE_COUNT)
		cm_clo[channel_capacity_index, t] = count_metric(road_map, merged, vehicles)
		omm_clo[channel_capacity_index, t], oma_clo[channel_capacity_index, t] = object_metrics(merged, objects)
